...
Flasgger also **provides validation** of the incoming data by using the same specification. It does this by validating the incoming data as a POST, PUT, or PATCH against the schema definition using either **YAML**, **Python dictionaries** or **Marshmallow Schemas**.
